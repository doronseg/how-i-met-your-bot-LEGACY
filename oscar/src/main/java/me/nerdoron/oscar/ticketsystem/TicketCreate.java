    ...
    public void onButtonClick(ButtonClickEvent event) {
        ...
        case "admin":
            TextChannel adminTicket = event.getGuild().getCategoryById("850458148723621888")
                    ...
                    .addPermissionOverride(event.getGuild().getPublicRole(), new ArrayList<>(), perms)
                    .addPermissionOverride(member, perms, new ArrayList<>()).complete();
            event.deferReply().setEphemeral(true).setContent("Created a ticket for you, " + adminTicket.getAsMention())
                    .queue();
        ...
        case "general":
            TextChannel staffTicket = event.getGuild().getCategoryById("850458148723621888")
                    ...
                    .addPermissionOverride(member, perms, new ArrayList<>()).complete();
            event.deferReply().setEphemeral(true).setContent("Created a ticket for you, " + staffTicket.getAsMention())
                    .queue();
